...
// Criando um objeto de rota para os Endpoints de categoria
...
router.get("/:id", async function(request, response) {
    // Recebe o id da categoria via parametro
...
router.delete("/:id", async function(request, response) {
    ...
    let result = await controllerCategoria.deletarCategoria(id)
